...
restart_btn = pygame.transform.scale(pygame.image.load(os.path.join("game_assets/lost_game", "restart.png")),(185,185))
you_lose = pygame.transform.scale(pygame.image.load(os.path.join("game_assets/lost_game","you_lose.png")),(800,200))
...
class LostGame:
    def __init__(self):
        ...
        self.bg = pygame.image.load(os.path.join("game_assets/lost_game", "bg_lose.png"))
    ...
    def run(self):
        pygame.mixer.music.load(os.path.join("game_assets/lost_game", "lose_music.mp3"))
