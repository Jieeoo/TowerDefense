...
catapulta_icon = pygame.transform.scale(pygame.image.load(os.path.join("game_assets/Menu", "catapulta_icon.png")),
                                        (75, 75))
...
class Game:
    def __init__(self, win):
        ...
        self.Menu.add_btn(catapulta_icon, "buy_trebuchette", 1000)
                        ...
                        if self.selected_tower:
                            ...
                            if btn_clicked:
                                if btn_clicked == "Upgrade":
                                    ...
                                    elif self.selected_tower.name in support_tower_name:
    ...
    def add_tower(self, name):
        ...
        object_list = [ArcherTower(x, y), WizardTower(x, y), TrebuchetteTower(x, y), RangeTower(x, y),
                       DamageTower(x, y)]
